...
class Crawler():
    ...
    def __init__(self, start_url="https://www.jjshu.net/0/74/index.html"):
    ...
    def parse_list(self, url):
        ...
        list_div = root.xpath('//div[@id="readerlist"]')[0]
...
def debug():
    Crawler.restart()
    crawler = Crawler(start_url='https://www.jjshu.net/0/74/index.html')
    crawler.run()
